package com.envarcade.brennon.neoforge
...
import net.neoforged.neoforge.event.entity.player.PlayerEvent as NeoPlayerEvent
import net.neoforged.neoforge.event.server.ServerStartingEvent
import net.neoforged.neoforge.event.server.ServerStoppingEvent
import java.util.UUID

/**
 * Brennon Network Core — NeoForge Mod.
 *
 * NeoForge-specific implementation, mirrors the Forge module
 * but uses NeoForge's event bus and API.
 */
@Mod("brennon")
class BrennonNeoForge {
    ...
    fun onServerStarting(event: ServerStartingEvent) {
        ...
        brennon = Brennon(Platform.NEOFORGE, dataFolder)
        brennon.enable()
        ...
        println("[Brennon] NeoForge mod loaded successfully.")
    }
    ...
    fun onServerStopping(event: ServerStoppingEvent) {
        brennon.disable()
        server = null
        println("[Brennon] NeoForge mod unloaded.")
    }

    @SubscribeEvent
    fun onPlayerJoin(event: NeoPlayerEvent.PlayerLoggedInEvent) {
    ...
    @SubscribeEvent
    fun onPlayerQuit(event: NeoPlayerEvent.PlayerLoggedOutEvent) {
        val player = event.entity as? ServerPlayer ?: return
    ...
    fun onRegisterCommands(event: RegisterCommandsEvent) {
        ...
        println("[Brennon] Registered ${brennon.commandRegistry.getCommands().size} NeoForge Brigadier commands.")
    }
